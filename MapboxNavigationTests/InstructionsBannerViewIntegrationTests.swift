...
func makeVisualInstruction(_ maneuverType: ManeuverType = .arrive,
    ...
    return VisualInstructionBanner(distanceAlongStep: 482.803, primary: primary, secondary: secondary, tertiary: nil, quaternary: nil, controlZone: nil, drivingSide: .right)
}
